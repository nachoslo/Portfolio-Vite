...
const LanguageBtn = () => {
  const { showMenu, setShowMenu } = useContext(LangContext);
  return (
    <button
      className={showMenu ? "language-btn language-btn-hover" : "language-btn"}
      onClick={() => setShowMenu(!showMenu)}
    >
      <svg height="20px" width="20px" viewBox="0 0 256 256">
        <path
          d="M62.4,101c-1.5-2.1-2.1-3.4-1.8-3.9c0.2-0.5,1.6-0.7,3.9-0.5c2.3,0.2,4.2,0.5,5.8,0.9c1.5,0.4,2.8,1,3.8,1.7
	...
	l31.9,10l5.7,22.3L227,201.9z M174.8,147.7l22.2,6.9l-10.9-42.9L174.8,147.7z"
      ...
      <svg
        ...
        height="12"
        viewBox="0 0 16 16"
        className={showMenu ? "icon-caret-up" : "icon-caret-down"}
      >
